//! Thin, bounded outbound-webhook adapter over the pinned Svix 1.99.1 SDK.
//!
...
//! deliberate provider edge because 1.99.1 cannot accept `rsk-outbound-http`, cap response bodies,
