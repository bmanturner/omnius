...
PostgreSQL is an external application dependency: provision a compatible
service for development and production, then supply its protected URL through
`OMNIUS__POSTGRES__URL`. The application or operator also owns migration
scheduling and any infrastructure files; generator lifecycle and upgrade
commands do not create or manage them.
